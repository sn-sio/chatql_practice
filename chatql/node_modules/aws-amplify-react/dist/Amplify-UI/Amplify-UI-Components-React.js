...
exports.FormSection = function (props) {
    var theme = props.theme || Amplify_UI_Theme_1.default;
    var style = props.theme.formContainer || Amplify_UI_Theme_1.default.formContainer;
...
exports.Button = function (props) {
    ...
    var p = core_1.JS.objectLessAttributes(props, 'theme');
    return exports.beforeAfter(React.createElement("button", __assign({}, p, { className: AmplifyUI.button, style: style }), props.children));
};
